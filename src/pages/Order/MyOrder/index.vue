    ...
    <div class="order-right">
        ...
        <div class="order-content">
            ...
            <div class="orders">
                <table
                    class="order-item"
                    v-for="order in orderDetail.records"
                    :key="order.id"
                >
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        >
                            <td width="60%">
                                <div class="typographic">
                                    <img
                                        ...
                                        style="width: 100px"
                                    />
                                    <a href="javascipt:;" class="block-text">{{
                                        detail.skuName
                                    }}</a>
                                    <span>x{{ detail.skuNum }}</span>
                                    <a href="javascipt:;" class="service"
                                        >售后申请</a
                                    >
                                </div>
                            </td>
                            ...
                            <td
                                ...
                                class="center"
                            >
                                <a href="javascipt:;" class="btn"
                                    >{{
                                        order.processStatus === "UNPAID"
                                            ? "未支付"
                                            : "已支付"
                                    }}
                                </a>
